...
from voicekit.obs.latency import LatencyMetric, LatencySample
from voicekit.obs.records import TimelineEvent, TranscriptRole, TranscriptTurn
from voicekit.runtimes.livekit.lifecycle import LiveKitRepository
...
class LiveKitObservationBridge:
    ...
    def _spawn(self, coroutine: Coroutine[Any, Any, None]) -> None:
        task = asyncio.create_task(
            coroutine,
            name=f"voicekit-livekit-observation-{self.call_id}",
        )
