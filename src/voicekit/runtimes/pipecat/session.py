...
from voicekit.runtimes.pipecat.mapping import PipecatPolicy
from voicekit.runtimes.pipecat.observability import PipecatObservationBridge
from voicekit.runtimes.pipecat.providers import (
    DefaultProviderFactory,
    PipecatServices,
    ProviderFactory,
    build_services,
)
from voicekit.storage.models import EndedReason, PersistedEvent
    ...
    def _wire_events(self, session: PipecatSession) -> None:
        ...
        async def on_pipeline_started(  # pyright: ignore[reportUnusedFunction]
            ...
            session.duration_task = asyncio.create_task(
                ...
                name=f"voicekit-duration-{session.call.call_id}",
            )
        ...
        async def on_pipeline_finished(  # pyright: ignore[reportUnusedFunction]
            ...
            if isinstance(frame, CancelFrame) and session.ended_reason is None:
                session.set_reason("worker_crash")
