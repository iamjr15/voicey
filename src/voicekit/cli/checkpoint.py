"""Secret-free wizard checkpoint stored in voicekit.jsonc until completion."""
...
class InitCheckpoint(VoicekitModel):
...
class InitCheckpointStore:
    ...
    def save(self, checkpoint: InitCheckpoint) -> None:
        payload = (
            "// Incomplete voicekit setup. Resume with: voicekit init --resume\n"
