...
from voicey.config.models import Agent, ModelAxis, Voice
            ...
            return cast(
                ...
                AnthropicLLMService(
                    ...
                    settings=AnthropicLLMService.Settings(
                        ...
                        # Sonnet 5 can emit a signature-only adaptive-thinking
                        # block that Pipecat 1.6.0 cannot read on the next tool turn.
