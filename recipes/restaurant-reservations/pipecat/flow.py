"""Native Pipecat Flows entrypoint for restaurant reservations."""
...
def entry(_flow_manager: FlowManager) -> NodeConfig:
    """Create the reservation coordinator as a native Pipecat node."""
    role = "\n\n".join(
    ...
    return NodeConfig(
        name="restaurant-reservation-coordinator",
        role_message=role,
